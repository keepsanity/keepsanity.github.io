...
const PROJECTS = [
  ...
  },
  {
    ...
    emoji: '📖',
    color: 'lime',
    desc: '로어북을 손으로 관리하는 대신, AI가 대화에서 기억을 정리하고 매 생성 직전에 관련 로어만 골라 주입합니다. 선택 엔진은 hybrid(BM25+벡터) · vector · bm25 · ai 중에 고를 수 있고, 임베딩은 실리태번의 Vector Storage 설정을 그대로 따릅니다.',
